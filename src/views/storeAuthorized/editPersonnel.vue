...
<template>
  <bm-layout>
    ...
    <div class="f15-c333 line-1 " slot="header" v-if="personVo">{{personVo.userId}}-{{personVo.userName}}</div>
    <div v-if="personVo">
...
export default {
  ...
  methods: {
    ...
    existStoreOrgVo () { // 从storeOrgVo 找到对应 人员信息
    ...
    confirmPerson (personVo) {
      ...
      if (data !== '{}') {
        this.$store.commit('storeAuthorized/editDetail/refreshPersonListVo', tempObj)
