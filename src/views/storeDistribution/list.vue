  ...
  <bm-layout>
    ...
    <div
      ...
      <div class="list-item"
        ...
        <div class="list-line">
          <div class="head-line">
            <div class="f15 color-999 flex justify-between" @click="toPage(`detail/${item.marketCode}/false/${item.isOwnMarket}`)">
    ...
    <div class="add" slot="left" @click="toPage('add')">
      <div class="add-btn">
          <p>新增</p>
          <p>巡检单</p>
      </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      toPage (str) {
        this.$router.push({path: 'storeDistribution/' + str})
      },
      search () {
        this.loading = false
      ...
      loadList () {
        this.keyword = ''
        this.$store.dispatch('storeDistribution/fetchMarketPollingList', {}).then(result => {
