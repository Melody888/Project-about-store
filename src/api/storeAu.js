...
// 01.根据登录用户获取门店编制列表信息
export const getStoreOrgListByUserCode = ({ data, params } = {}) => {
  return sfa.post('/storeOrg/getStoreOrgListByUserCode', data, { params })
}
// 02.根据门店编码查看编制信息
export const getStoreOrgInfoByStoreId = ({ data, params } = {}) => {
...
// 360门店.根据门店编码查看编制信息
export const getStoreOrgInfoByStoreId360 = ({ data, params } = {}) => {
  return sfa.post('/store360/getStoreOrgInfoByStoreId', data, { params })
}
